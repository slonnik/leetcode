...
public class TreeNodes {
    ...
    public static boolean isSameTree(TreeNode p, TreeNode q) {
        return internalSameTree(p, q);
    }

    private static boolean  internalSameTree(TreeNode p, TreeNode q) {
        if (p == null && q == null) {
            return true;
        }
        if (p == null || q == null) {
        ...
        return internalSameTree(p.right, q.right) && internalSameTree(p.left, q.left);
    }
}
